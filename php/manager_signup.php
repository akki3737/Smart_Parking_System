...
if(isset($_POST['manager_signup']))
{
	...
	$sql="insert into manager_signup(firstname,lastname,contact,emailid,password,sex) values('$fname','$lname','$contact','$email','$password2','$sex')" or die("Failed to Query database ".mysql_error());
