...
//echo($dist);
$sql="select pid,latitude,longitude from manager_park_lot where pid in(select pid from slot_park_rel where status='open')";
//echo($sql);
    ...
    if($resultCheck3>0)
    {
      while($row=mysqli_fetch_assoc($result3))
        ...
        <div class="child_class">
            <div>
                <img class="images" src="../img/park.png">
            </div>
            <div class="content">;
           ...
           <div class="content2">;
            ...
            <div>
               <a href="../html/parking_slot.html"><button >Book</button></a>
            </div>
        </div>';
                   }   
        $flag=1;
...
echo '</div>
<div id="iframe">
<iframe src="plot.php" width="650px" height="600px" frameborder="0"></iframe>
</div>
</body>
</html>';
//$sql4="select "
...
/*function geocode($address){
    ...
    // url encode the address19.203566 73.184723
